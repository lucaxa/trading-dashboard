...
(() => {
  ...
  function createPanel() {
    ...
    if (!main) {
      ...
      console.warn(
        "[TradeMind V2] PMSE container target not found."
      );
        ...
        .map(
          candidate => {
            ...
            return `
              ...
              <article
                class="v2-pmse-candidate"
              >

                <div
                  class="v2-pmse-candidate-top"
                >

                  <span
                    class="v2-pmse-symbol"
                  >
                    ${symbol}
                  </span>
