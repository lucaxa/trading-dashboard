/*
===========================================================
 TradeMind Pro — V2 Mobile Navigation
 STEP 6 — FRONTEND UI/UX ONLY
 ----------------------------------------------------------
 Purpose:
 - Add a mobile navigation trigger.
 - Turn the existing desktop sidebar into a mobile drawer.
 - Preserve existing sidebar navigation handlers.
 - No API calls.
...
(() => {
  ...
  function initMobileNavigation() {
    ...
    /*
     * Put the menu button before the mobile brand so the mobile
     * header reads naturally: menu → brand → status/mode.
     */
    ...
    button.addEventListener("click", () => {
      if (sidebar.classList.contains("v2-mobile-open")) {
        closeMenu();
      } else {
        openMenu();
      }
    ...
    /*
     * Existing v2-nav.js handles the actual navigation.
     * We only close the drawer after a sidebar item is clicked.
     */
    ...
    console.info(
      "[TradeMind V2] Mobile navigation ready — frontend only."
    );
  }
