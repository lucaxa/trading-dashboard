...
============================================================
TradeMind Pro
V25.9 — LEARNING RECORD CONSTRUCTION AUDIT
============================================================

PURPOSE
------------------------------------------------------------
Audit controlled learning-record construction from the
frozen V25.7 canonical Dhan dataset and the V25.8.2-approved
feature set before any learning-engine or candidate-discovery
work is allowed.
...
const OUTPUT_FILE =
    ...
    "v25_9_learning_record_audit.json";
...
if (!featureDiagnosticPass || !learningRecordAuditPass) {
    process.exitCode = 1;
}
