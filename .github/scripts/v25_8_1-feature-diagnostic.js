...
PURPOSE
------------------------------------------------------------
Audit the frozen V25.7 canonical Dhan dataset before any
learning-engine, candidate-discovery, validation, OOS, or
strategy work is allowed.
...
const OUTPUT_FILE =
    ...
    "v25_8_1_feature_diagnostic.json";
